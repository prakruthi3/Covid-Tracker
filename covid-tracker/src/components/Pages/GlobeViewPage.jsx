...
import { confirmedHistory, deathsHistory, recoveredHistory } from '.././redux/actions/GlobeViewAction';
    ...
    render() {
        return (
            <div className="map">
                ...
                <Globe chartData={this.props.history} color={this.state.color} border={this.state.border} />
